...
class BasketballMatchLoader:
    ...
    def load_all_match(self):
        ...
        for i in range(len(df_basketball)):
            ...
            joueur_home_lignes = df_basketball_joueurs[df_basketball_joueurs["team_id_home"] == id_home]
            joueur_away_lignes = df_basketball_joueurs[df_basketball_joueurs["team_id_away"] == id_away]
