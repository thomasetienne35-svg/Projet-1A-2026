...
class VisualisationComparateur:
    ...
    def comparer_joueurs(
        self, stats_j1: dict[str, Any], stats_j2: dict[str, Any]
    ) -> None:
        ...
        valeurs_j1 = [
            stats_j1["matchs_joues"],
            stats_j1["victoires"],
            stats_j1["defaites"],
            wr1,
        ]
        valeurs_j2 = [
            stats_j2["matchs_joues"],
            stats_j2["victoires"],
            stats_j2["defaites"],
            wr2,
        ]
        ...
        ax.set_title(
            f"Comparaison Joueurs : {nom1} vs {nom2} ({stats_j1['sport']})",
            fontsize=14,
            fontweight="bold",
        )
        ax.set_xticks(x)
    ...
    def comparer_equipes(
        self, stats_e1: dict[str, Any], stats_e2: dict[str, Any]
    ) -> None:
        ...
        valeurs_e1 = [
            stats_e1.get("matchs_joues", 0),
            stats_e1.get("victoires", 0),
            stats_e1.get("defaites", 0),
            pour_e1,
            contre_e1,
        ]
        valeurs_e2 = [
            stats_e2.get("matchs_joues", 0),
            stats_e2.get("victoires", 0),
            stats_e2.get("defaites", 0),
            pour_e2,
            contre_e2,
        ]
        ...
        ax.set_ylabel("Statistiques", fontweight="bold")
        ax.set_title(
            f"Comparaison Équipes : {nom1} vs {nom2}", fontsize=14, fontweight="bold"
        )
        ax.set_xticks(x)
        ax.set_xticklabels(labels)
        ax.legend()
