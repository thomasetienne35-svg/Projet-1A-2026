...
class VolleyPlayerLoader:
    ...
    def load_all_player(self):
        ...
        df_volley_men = pd.read_csv(
            "c:/Users/id2959/Desktop/Projet-1A-2026/data/volleyball_tdd/player_men.csv"
        )
        for i in range(len(df_volley_men)):
            ...
            joueur.date_naissance = df_volley_men.loc[i, "birthday_date"]
            res.append(joueur)

        df_volley_women = pd.read_csv(
            "c:/Users/id2959/Desktop/Projet-1A-2026/data/volleyball_tdd/player_women.csv"
        )
        for i in range(len(df_volley_women)):
            ...
            joueur.date_naissance = df_volley_women.loc[i, "birthday_date"]
            res.append(joueur)
        return res
