...
def preparer_donnees_test() -> tuple[list[SimpleNamespace], list[SimpleNamespace]]:
    ...
    match_1 = SimpleNamespace(
        ...
        home_team_goal = 2, away_team_goal = 1
    )
    match_2 = SimpleNamespace(
        season="2024", 
        home_team_api_id = 20, away_team_api_id = 10, 
        home_team_goal = 1, away_team_goal = 1
    )
...
def test_calcul_basketball_points() -> None:
    ...
    m_basket = SimpleNamespace(
        season = "2024",
        team_id_home = 100, team_id_away = 200,
...
def test_lol_kda_et_winrate() -> None:
    ...
    m_lol = SimpleNamespace(
        team_blue = "fnatic", team_red = "g2",
        winner = "fnatic",
        kills_team_blue = 10, deaths_team_blue = 2, assists_team_blue = 10
    )
