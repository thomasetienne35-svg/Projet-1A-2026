...
![Extracteur de taille](Images_partie3/image1.png){width="75%" fig-align="center"}
...
![Extrait du filtre de recherche](Images_partie3/image2.png){width="85%" fig-align="center"}
...
![Création d'un joueur et assignation des attributs](Images_partie4/image1.png){width="75%" fig-align="center"}
...
![Concaténation de deux dataframes dans TennisPlayerLoader](Images_partie4/image2.png){width="75%" fig-align="center"}
...
![Classe AnalysePhysiologique](Images_partie4/image3.png){width="75%" fig-align="center"}

## Les avantages de cette architecture logicielle
...
![Extrait du player.csv de basketball](Images_partie5/image1.png){width="75%" fig-align="center"}
...
Nous avons fait le choix de ne pas tester le fichier main.py car c'est un menu d'affichage. Il relie l'utilisateur au reste du programme. Pour vérifier que le menu visuel fonctionne bien et réagit correctement aux choix de l'utilisateur nous l’avons testé nous-mêmes à la main.
La majorité de nos classes (ChampionshipPointsCalculator, AnalysePhysiologique, etc.) dépendent de volumes de données importants. Pour garantir des tests rapides et déterministes, nous avons fait le choix de ne pas charger les vrais fichiers de données lors des tests. Nous avons simulé des objets "matchs" et "équipes" très simple en utilisant *SimpleNamespace*. Cela nous a permis de cibler précisément la logique de nos classes tel que le ratio de victoire au basket.
De plus pour le test de certaines classes nécessite que l'utilisateur rentre des informations dans le terminal. Nous avons donc utilisé l'outil *unittest.mock.patch*. Cela nous a permis de simuler les réponses d'un utilisateur humain et de vérifier que notre programme réagit correctement face aux erreurs de saisie.
Pour les modules de statistiques générant des graphiques, les tests sont donc concentrés sur l'exécution sans erreur de la bibliothèque mathématique et sur l'assertion de la présence du fichier final. C’est à dire vérifier si le fichier image a bien été créé et sauvegardé sur l'ordinateur. Si le fichier final existe, cela nous prouve que tout le processus de génération a fonctionné correctement.

![Résultat du test coverage pytest-cov](Images_partie6/image2.png){width="75%" fig-align="center"}
...
![Menu principal du terminal](images_partie7/image1.png){width="95%" fig-align="center"}
...
![Résultats des statistiques sur une équipe](images_partie7/image2.png){width="75%" fig-align="center"}
...
![Comparaison des résultats de deux équipes](images_partie7/image3.png){width="75%" fig-align="center"}
...
![Heatmap entre la taille et le pourcentage de victoire](images_partie7/image4.png){width="75%" fig-align="center"}
...
![Mise à jour des attributs d'un joueur](images_partie7/image5.png){width="75%" fig-align="center"}
...
Techniquement, ça a été l'occasion d'appliquer la programmation objet de notre dernier DM sur un cas très concret. De plus, j’ai découvert des outils de test plus variés pour répondre aux caractéristiques de nos différentes classes. Ça a été très satisfaisant de passer d’un tableau de données brutes à des statistiques interactives.
